...
Phase 2 additions:
  ...
  SITUATION_FIRED     { situation_type, settlement_id, week, year, season }
  ENTITY_ACT          { actor_id, action_type, settlement_id, week, year }
  REPUTATION_EVENT    { event_type, actor_id, witness_id, location, infamy_delta, honour_delta }
  NARRATIVE_QUEUED    { payload }          -- story ready for LLM rendering
  PROMINENCE_CHANGED  { entity_id, old_val, new_val, reason }
]]
